...
func main() {
	...
	routerGroup := router.Group("")
	{
		...
		router.POST("/post/map", control.Rout.PostMap)

		router.POST("/upload/picture", control.Rout.UploadPicture)
		router.POST("/upload/pictures", control.Rout.UploadPictures)
	}
